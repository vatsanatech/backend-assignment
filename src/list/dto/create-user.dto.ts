...
export class WatchHistoryItem {
  ...
  @ApiProperty({
    description: 'The date the content was watched',
...
export class MyListItem {
  @ApiProperty({
    description: 'The ID of the content in the list',
    example: 'xyz789',
  })
  @IsNotEmpty()
  @IsString()
...
export class CreateUserDto {
  ...
  @ApiProperty({
    description: 'User’s disliked genres',
    isArray: true,
    enum: genre,
  })
  @IsArray()
  ...
  @ApiProperty({
    ...
    description: 'History of watched content',
  })
  @IsArray()
  @IsOptional()
